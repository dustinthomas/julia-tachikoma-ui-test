...
|---|---|---|
| `src/domain.jl` | `test_domain.jl` | `test_stores.jl`, `test_gfx.jl` |
...
| `src/ui/app.jl` (AppModel, dispatch, login gate) | `test_app_shell.jl` | `test_fixwave.jl`, `test_focus.jl` |
| `src/ui/theme.jl` | `test_theme.jl` (incl. raw-ColorRGB grep enforcement) | — |
| `src/ui/focus.jl`, `src/ui/keymap.jl` | `test_focus.jl` | `test_app_shell.jl` |
| `src/ui/board.jl` | `test_board_view.jl` | `test_focus.jl`, `test_notify.jl`, `test_stores.jl` |
| `src/ui/backlog.jl` | `test_backlog.jl` | `test_gfx.jl` (burndown footer) |
