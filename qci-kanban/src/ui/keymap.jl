...
const KEYMAP = Binding[
    ...
    Binding(:gantt, 'z',    :gantt_zoom,         "z",     "Scale day/wk/mo", true),
    Binding(:gantt, '+',    :gantt_stretch_in,   "+",     "Stretch +",  true),
    Binding(:gantt, '=',    :gantt_stretch_in,   "=",     "Stretch +",  false),
    Binding(:gantt, '-',    :gantt_stretch_out,  "-",     "Stretch −",  true),
    Binding(:gantt, '_',    :gantt_stretch_out,  "_",     "Stretch −",  false),
