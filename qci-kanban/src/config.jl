...
Base.@kwdef mutable struct AppConfig
    ...
    # Production seed controls (PR-M3 / design §4.7):
    # `seed_demo=true` keeps tests/demo ergonomics; plant installs set false
    # via config/maintenance.toml.example or QCI_SEED_DEMO=0.
    seed_demo::Bool = true
